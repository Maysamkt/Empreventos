...
//    }
    ...
    public User(Integer id, String name, String password, String cpf_cnpj, String email, String phone_number, Boolean active, String avatar_url, String bio, Date created_at, Date updated_at, Date deleted_at, Set<UserRole> userRoles) {
        this.id = id;
        this.name = name;
